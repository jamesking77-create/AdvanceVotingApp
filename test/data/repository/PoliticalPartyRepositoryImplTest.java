...
class PoliticalPartyRepositoryImplTest {
    ...
    @Test public void saveTwoParty_findPartyByPartyNameTest(){
        PoliticalParty firstParty = politicalPartyRepository.savePoliticalParty(politicalParty2);
        assertEquals(1, politicalParty2.getId());
        PoliticalParty secondParty = politicalPartyRepository.savePoliticalParty(politicalParty);
        assertEquals(2, politicalParty.getId());
        PoliticalParty foundParty = politicalPartyRepository.findPartyByPartyName(politicalParty.getName());
        assertEquals(secondParty.getName(), foundParty.getName());
    }
}